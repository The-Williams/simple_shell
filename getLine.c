...
/**
 * _getline - next line input from STDIN is gotten
 * @info: structure of the parameter
 * @ptr: preallocated, buffer or NULL from pointer address
 * @length: preallocated size of ptr buffers if not NULL
 *
 * Return: s
 */
...
/**
 * sigintHandler -  coping is blocked
 * @sig_num: num of the signal
 *
 * Return: to be void
 */
